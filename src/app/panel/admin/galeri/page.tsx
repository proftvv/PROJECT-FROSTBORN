...
export default async function AdminGalleryPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-display text-2xl text-snow-100">Galeri Yönetimi</h1>
        <p className="mt-1 text-sm text-snow-300/60">Public galeride görünecek görselleri ekle.</p>
      </div>
      <GalleryForm />
