...
export const metadata = { title: "Takim Sohbet" };
...
export default async function TeamChatPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-display text-2xl text-snow-100">Takim Sohbeti</h1>
        <p className="mt-1 text-sm text-snow-300/60">Nordian'lara ozel alan.</p>
      </div>
