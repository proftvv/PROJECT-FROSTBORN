...
![Version](https://img.shields.io/badge/S%C3%BCr%C3%BCm-0.3.000-88C0D0?style=for-the-badge)
...
### 🗂️ Admin Paneli
- Başvuru inceleme ve yanıtlama
- Üye kayıt işlemleri ve rütbe yönetimi
- Otomatik e-posta bildirimleri ([Resend](https://resend.com/) entegrasyonu)
...
```
BIFROST ──► MIDGARD ──► HEIMDALL ──► VALHALLA ──► ODIN ──► SKALD ──► FENRIR
 Altyapı     Vitrin      Kimlik       Panel      Yönetim    Forum     Mobil
```
